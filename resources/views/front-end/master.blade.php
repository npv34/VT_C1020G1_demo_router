...
<head>
    ...
    <!-- Nice Select CSS -->
    <link rel="stylesheet" href="{{ asset('front-end/css/niceselect.css') }}">
    <!-- Animate CSS -->
    <link rel="stylesheet" href="{{ asset('front-end/css/animate.css') }}">
    <!-- Flex Slider CSS -->
    <link rel="stylesheet" href="{{ asset('front-end/css/flex-slider.min.css') }}">
    <!-- Owl Carousel -->
    ...
    <!-- Eshop StyleSheet -->
    <link rel="stylesheet" href="{{ asset('front-end/css/reset.css') }}">
...
<!-- Header -->
@include('front-end.core.header')
<!--/ End Header -->
@yield('home_page')

<!-- Start Footer Area -->
@include('front-end.core.footer')
...
<!-- Bootstrap JS -->
<script src="{{ asset('front-end/js/bootstrap.min.js') }}js/bootstrap.min.js"></script>
<!-- Color JS -->
{{--<script src="{{ asset('colo') }}js/colors.js"></script>--}}
<!-- Slicknav JS -->
<script src="{{ asset('front-end/js/slicknav.min.js') }}"></script>
<!-- Owl Carousel JS -->
...
<!-- Countdown JS -->
<script src="{{ asset('front-end/js/finalcountdown.min.js') }}"></script>
<!-- Nice Select JS -->
<script src="{{ asset('front-end/js/nicesellect.js') }}"></script>
<!-- Flex Slider JS -->
<script src="{{ asset('front-end/js/flex-slider.js') }}"></script>
<!-- ScrollUp JS -->
<script src="{{ asset('front-end/js/scrollup.js') }}"></script>
<!-- Onepage Nav JS -->
